        ...
        >
          ...
          >
            <div className="space-y-1.5">
              <label className="text-xs font-medium tracking-widest uppercase" style={{ color: "rgba(255,255,255,0.35)" }}>Email</label>
            ...
            <motion.button type="submit" disabled={loading}
              ...
              style={{
                ...
                boxShadow: loading ? "none" : "0 0 30px rgba(139,92,246,0.35), 0 4px 16px rgba(0,0,0,0.3)",
              }}
            >
              {loading ? (
          ...
          <p className="text-center text-xs mt-6" style={{ color: "rgba(255,255,255,0.25)" }}>
            No account?{" "}
            <Link href="/register" className="font-medium" style={{ color: "#a78bfa" }}>Create workspace</Link>
          </p>
        </motion.div>
      </div>
    </div>
