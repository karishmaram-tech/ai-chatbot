...
export default function ChatPage() {
  const { token, messages, sidebarOpen, setSidebarOpen, isLoading,
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: "#0C0A09" }}>
      <AmbientBackground />
      <Sidebar />
      ...
      <div className="flex flex-col flex-1 min-w-0 relative z-10">
        ...
        <header className="flex items-center gap-3 px-5 py-3 flex-shrink-0"
          ...
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
            ...
            style={{ color: "#6B6059" }}
            onMouseEnter={(e) => { e.currentTarget.style.color = "#F5F0EB"; e.currentTarget.style.background = "#1C1916"; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = "#6B6059"; e.currentTarget.style.background = "transparent"; }}
          >
            <Menu size={17} />
          </motion.button>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <span className="text-xs" style={{ color: "#4A4238" }}>Live</span>
          </div>
        </header>
            ...
            {isEmpty ? (
              ...
              >
                ...
                <motion.h2
                  ...
                  style={{ fontFamily: "Instrument Serif, Georgia, serif", fontWeight: 400, color: "#F5F0EB" }}
                >
                ...
                <motion.p
                  ...
                  style={{ color: "#6B6059", lineHeight: 1.7 }}
                >
                  Ask anything. Upload documents for context.
                  <br />
                  Lumora AI remembers your conversation.
                </motion.p>
                <motion.div
                ...
                >
                  {PROMPTS.map(({ icon: Icon, label, text }, i) => (
                    <motion.button key={text}
                      ...
                      onMouseLeave={(e) => { e.currentTarget.style.borderColor = "#1C1916"; }}
                    >
                      ...
                      <div>
                        <p className="text-[10px] font-medium tracking-wider uppercase mb-1" style={{ color: "#4A4238" }}>{label}</p>
                        <p className="text-xs leading-relaxed" style={{ color: "#8C8279" }}>{text}</p>
                      </div>
                    </motion.button>
                  ))}
                </motion.div>
