...
export function TypingIndicator() {
  return (
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="flex-shrink-0 mt-0.5"><LumoraLogo size="xs" showText={false} /></div>
      <div className="flex items-center gap-2.5 py-2">
        <span className="text-xs tracking-widest uppercase" style={{ color: "rgba(255,255,255,0.2)" }}>thinking</span>
