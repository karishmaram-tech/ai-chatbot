  ...
  return (
    <div className="px-3 sm:px-4 pb-4 sm:pb-6 pt-2 flex-shrink-0">
      <motion.div
        animate={{
          boxShadow: focused
            ? "0 0 0 1px rgba(139,92,246,0.4), 0 8px 32px rgba(0,0,0,0.5), 0 0 40px rgba(139,92,246,0.06)"
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex items-end gap-2 sm:gap-3 px-3 sm:px-4 pt-3 sm:pt-4 pb-2 sm:pb-3">
            ...
            <textarea ref={textareaRef} value={input}
              ...
              onKeyDown={(e) => { if (e.key === "Enter" && !e.shiftKey && !e.nativeEvent.isComposing) { e.preventDefault(); handleSubmit(e as any); } }}
            ...
            <AnimatePresence mode="wait">
              <motion.button key={canSend ? "on" : "off"}
              ...
              >
                {isLoading ? (
                  <motion.span animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                    ...
                    style={{ width: 14, height: 14, border: "2px solid rgba(255,255,255,0.3)", borderTopColor: "white" }} />
                ) : (
