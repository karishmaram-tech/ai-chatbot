...
import { FileSearch, Zap, Brain, X, ArrowRight, Upload, Check } from "lucide-react";
import { LumoraLogo } from "@/components/ui/LumoraLogo";

const STEPS = [
  {
    icon: Brain,
    title: "Welcome to Lumora AI",
    subtitle: "Your intelligent workspace",
    desc: "Lumora AI is not just another chatbot. It combines real-time streaming with document intelligence — meaning it can read your PDFs and answer questions about them.",
    action: "Next",
    visual: "brain",
  },
  {
    ...
    action: "Next",
    visual: "rag",
    tip: "Try uploading a research paper, report, or any PDF you want to explore",
  },
  {
    icon: Zap,
    title: "Real-time Streaming",
    subtitle: "Answers appear as they generate",
    desc: "Every response streams word-by-word in real time. You see the AI thinking. Combined with RAG, every answer is grounded in what you actually uploaded.",
    ...
    >
      ...
      >
        <button onClick={onClose}
          className="absolute top-4 right-4 z-10 w-7 h-7 rounded-lg flex items-center justify-center transition-all"
        ...
        <div className="p-8">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="text-center mb-6">
                <p className="text-xs font-medium tracking-widest uppercase mb-2" style={{ color: "rgba(139,92,246,0.7)" }}>
                  {current.subtitle}
                </p>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              {current.action} {!isLast && <ArrowRight size={14} />}
