    ...
    <motion.div className="flex items-center gap-2.5 select-none" whileHover={{ scale: 1.02 }} transition={{ duration: 0.15 }}>
      ...
      >
        <svg width={px*0.55} height={px*0.55} viewBox="0 0 24 24" fill="none">
          ...
          <line x1="5.6" y1="5.6" x2="8.8" y2="8.8" stroke="#a78bfa" strokeWidth="1" strokeLinecap="round" opacity="0.3" />
          <line x1="15.2" y1="15.2" x2="18.4" y2="18.4" stroke="#a78bfa" strokeWidth="1" strokeLinecap="round" opacity="0.3" />
          <line x1="18.4" y1="5.6" x2="15.2" y2="8.8" stroke="#67e8f9" strokeWidth="1" strokeLinecap="round" opacity="0.3" />
          <line x1="8.8" y1="15.2" x2="5.6" y2="18.4" stroke="#67e8f9" strokeWidth="1" strokeLinecap="round" opacity="0.3" />
        </svg>
      </div>
      {showText && (
